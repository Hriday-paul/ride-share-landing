            ...
            <div className='container'>
                ...
                "
                    ...
                    <div className='col-span-5 space-y-3.5 md:space-y-4 lg:space-y-5'>
                        ...
                        <motion.h4 initial={{ y: 10, opacity: 0 }}
                            whileInView={{
                                opacity: 1,
                                y: 0,
                                transition: {
                            ...
                            viewport={{ once: true }}
                            className='text-2xl md:text-4xl lg:text-5xl leading-8 md:leading-10 lg:leading-12 font-extrabold font-fustat'>Fast & Easy Ride Booking at Your Fingertips</motion.h4>
